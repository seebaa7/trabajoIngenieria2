...
<body background="imagenes/fondo4.jpg">
  <?php include("header.php"); ?>
   <section class="main container"> 
     ...
     <form  action="resultado.php" method="POST" style="color: #FFF;"> 
          ...
          <p>   <input name="alq" type="checkbox"> Ganancia de porcentaje de alquileres</p>

          <p>   <input name="prem" type="checkbox"> Ganancia por usuarios premium </p>



          <p style="color: #000 ">   <input name="boton" type="submit" value="Consultar">  </p>
