...
<body background="imagenes/fondo4.jpg">
  <?php include("header.php"); ?>
   <section class="main container" >
        ...
        <div class="container">
            <h3>Pagar Hospedaje</h3>
        </div>      </section>
       
       

<div id="formulario" > 
<form action="pagar1.php" class="formoid-flat-green" style="background-color:#2d2d2d;font-size:14px;font-family:'Lato', sans-serif;color:#666666;max-width:480px;min-width:150px" method="post">
  ...
  <div class="element-select"><label class="title">Tipo de Documento<span class="required">*</span></label><div class="large"><span><select name="select1" required="required">
	...
	<input hidden type="text" name="idh" id="pagar" value=<?php echo $idh; ?> >
