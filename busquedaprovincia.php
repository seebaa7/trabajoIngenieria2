...
$datos50 = mysql_query("Select * from provincia");
}?>
...
<body background="imagenes/fondo4.jpg">
 ...
 <aside class="col-md-3 hidden-xs hidden-sm" >
  ...
  <div class="content" > 
    <div id="cuerpo" >
    <br>
 <p style="color:white"> Seleccione la provincia donde se encuentra el hospedaje deseado:  </p>
<form action="busquedaprovincia1.php" method="get">
<select name="idprov">
<?php 
while ($dato=mysql_fetch_array($datos50)){ ?>
	<option value=" <?php echo $dato['idprov']; ?> "><?php echo $dato['nombre']; ?> </option>
<?php } ?>
</select>
<br>
<br>
<button  type="submit" style="border:0;background:transparent;outline:none;-webkit-appearance:none;color:lightblue" title="Buscar Hospedajes con la Provincia Seleccionada" > <span class="glyphicon glyphicon-search"></span> </button> </form>
<br>
